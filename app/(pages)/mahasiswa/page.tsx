...
export default function MahasiswaPage() {
  ...
  // Hitung range data yang sedang ditampilkan (misal: 1-10)
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          onClick={handleAdd}
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-[#1B3F95] text-white text-sm font-semibold rounded-xl hover:bg-blue-800 transition shadow-lg shadow-blue-900/20 active:scale-95"
        >
        ...
        <div className="p-5 border-b border-slate-100 bg-slate-50/50">
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="block w-full pl-10 pr-4 py-2.5 border border-slate-200 rounded-lg text-sm bg-white text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1B3F95]/20 focus:border-[#1B3F95] transition-all shadow-sm"
            />
          </div>
        </div>
                ...
                currentData.map((student, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <span className="inline-flex items-center justify-center w-6 h-6 rounded bg-blue-50 text-[#1B3F95] text-xs font-bold">
          ...
          <div className="p-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between bg-white rounded-b-xl gap-4">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="px-3 py-1.5 text-xs font-medium rounded-lg border border-slate-200 hover:bg-slate-50 text-slate-600 disabled:opacity-50 disabled:cursor-not-allowed transition bg-white"
              >
                Prev
              </button>
                ...
                {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-8 h-8 flex items-center justify-center text-xs rounded-lg font-bold transition-all ${
                        currentPage === p
